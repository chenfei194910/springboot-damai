package com.springboot.three.config.dbconfig;
...
@MapperScan(basePackages="com.springboot.three.dao")
public class MybatisConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactorys() throws Exception {
       ...
       //     sessionFactoryBean.setDataSource(roundRobinDataSouce);
            ...
            // 读取配置 
            sessionFactoryBean.setTypeAliasesPackage("com.springboot.three.domain");
